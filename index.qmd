...
- Effektexistenz und Effektstärke zentrale Entität, um praktische Schlussfolgerungen zu ziehen
...
| | | | |
|--|--|--|--|
|![](img/CHU_Forschendes%20Lernen.png){.lightbox width="140" fig-align="left"}[@knogler2017]|![](img/Tüdibase_Gamification.png){.lightbox width="140" fig-align="left"}[@backfisch2021]|![](img/PM_virtuelles%20Klassenzimmer.png){.lightbox width="140" fig-align="left"}[@rijkhoek2019]|![](img/Welt_PISA.png){.lightbox width="140" fig-align="left"}[@michler2014]|
</center>
...
* H1a: Empfehlung<sub>keine Effektstärke präsentiert</sub> > Empfehlung<sub>kleine Effektstärke (Text)</sub>
* H1b: Empfehlung<sub>keine Effektstärke präsentiert</sub> ≅ Empfehlung große Effektstärke (Text) 

*Guestimation* 

* H1c: Wahrgenommene Effektstärke<sub>keine Effektstärke präsentiert</sub> > Wahrgenommene Effektstärke<sub>kleine Effektstärke (Text)</sub>
* H1d: Wahrgenommene Effektstärke<sub>keine Effektstärke präsentiert</sub> ≅ Wahrgenommene Effektstärke<sub>große Effektstärke (Text)</sub>

**Effektstärkenverständnis**

*Wahrgenommene Effektstärke* 

* H2a: Wahrgenommene Effektstärke<sub>große Effektstärke (Text)</sub> > Wahrgenommene Effektstärke<sub>kleine Effektstärke (Text)</sub>
* H2b: Wahrgenommene Effektstärke<sub>große Effektstärke (BESD)</sub> > Wahrgenommene Effektstärke<sub>kleine Effektstärke (BESD)</sub>
* H2c: Wahrgenommene Effektstärke<sub>kleine Effektstärke (Text)</sub> > Wahrgenommene Effektstärke<sub>kleine Effektstärke (BESD)</sub>

*Akkuratheit der Effektstärkeneinschätzung *

* H3a: Einschätzungsfehler der Effektstärke<sub>große Effektstärke (Text)</sub> > Einschätzungsfehler der Effektstärke<sub>große Effektstärke (BESD)</sub>
* H4b: Einschätzungsfehler der Effektstärke<sub>kleine Effektstärke (Text)</sub> > Einschätzungsfehler der Effektstärke<sub>kleine Effektstärke (BESD)</sub>
...
<center>![](img/Abbildung_rating_error.png){.lightbox width="700"}</center>
...
* Präsentation von Effektstärken (Text und BESF) eine Möglichkeit Practical Significance Bias vorzubeugen
  + Obwohl einfach konstruiertes Beispiel (Neues vs. altes Curriculum, Regelstandards erreicht vs. Regelstandards nicht erreicht), Unterschied zwischen Text und BESD vorhanden
  + BESD scheint Verzerrungen in der Effektstärkenwahrnehmung stärker zu reduzieren

* Limitationen: 
  + Einfach konstruiertes Beispiel
